...
```
![image](https://user-images.githubusercontent.com/115066298/236676570-325bba4a-b427-4e0a-bbb4-8df638ba246c.png)
...
```
1. Calaulator.AddValues(7, 8d) เรียกใช้ method AddValues(int a, double b)
2. Calaulator.AddValues(1, 2) เรียกใช้ method AddValues(int a, int b)
3. Calaulator.AddValues(1, 2, 3) เรียกใช้ method AddValues(int a, int b, int c)
4. Calaulator.AddValues(5f, 6f) เรียกใช้ method AddValues(int a, float b)
5. Calaulator.AddValues(9f, 4) เรียกใช้ method AddValues(double a, double b)
```
---
...
```
![image](https://user-images.githubusercontent.com/115066298/236676706-c1f51a99-a1f2-4cdd-87b6-5eef1be1f040.png)
...
```
![image](https://user-images.githubusercontent.com/115066298/236676835-35562106-3e63-4501-85ee-c5f02f49fabc.png)
