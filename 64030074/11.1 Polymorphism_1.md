...
```
![image](https://github.com/tnpn2545/Week-11/assets/115066414/decdac7f-e900-41ef-b16f-ff8a378c5415)

## คำถาม
1. โปรแกรมด้านบนสามารถทำงานได้ทุกบรรทัดหรือไม่<br>
```
สามารถทำงานทุกบรรทัด
```
2. จงระบุว่าคำสั่งใดใน Main() เรียก method ใดในคลาส Calculator 
```
Calculator.AddValues(7, 8d) เรียกใช้เมท็อด AddValues(int a, double b) และพิมพ์ผลลัพธ์ที่ได้จากการบวกเลข 7 กับ 8d (double) บนหน้าจอ.
Calculator.AddValues(1, 2) เรียกใช้เมท็อด AddValues(int a, int b) และพิมพ์ผลลัพธ์ที่ได้จากการบวกเลข 1 กับ 2 บนหน้าจอ.
Calculator.AddValues(1, 2, 3) เรียกใช้เมท็อด AddValues(int a, int b, int c) และพิมพ์ผลลัพธ์ที่ได้จากการบวกเลข 1, 2, และ 3 บนหน้าจอ.
Calculator.AddValues(5f, 6f) เรียกใช้เมท็อด AddValues(int a, float b) และพิมพ์ผลลัพธ์ที่ได้จากการบวกเลข 5f (float) กับ 6f (float) บนหน้าจอ.
Calculator.AddValues(9f, 4) เรียกใช้เมท็อด AddValues(double a, double b) และพิมพ์ผลลัพธ์ที่ได้จากการบวกเลข 9f (float) กับ 4 บนหน้าจอ.
```
---
...
```
![image](https://github.com/tnpn2545/Week-11/assets/115066414/5b174736-4670-403c-9bde-bb4a8936df02)
...
```
![image](https://github.com/tnpn2545/Week-11/assets/115066414/b75cd03e-93ea-4c4f-a271-86cd870670d4)
