...
```
![image](https://user-images.githubusercontent.com/115066186/236042863-98d57cc0-2c3a-4483-9ef1-457e0a44c0a7.png)

## คำถาม
1. โปรแกรมด้านบนสามารถทำงานได้ทุกบรรทัดหรือไม่
   ได้ทุกบรรทัด
2. จงระบุว่าคำสั่งใดใน Main() เรียก method ใดในคลาส Calculator 
3. โปรแกรม Main() เรียกใช้ method ในคลาส Calculator ดังนี้

1. `Console.WriteLine(Calaulator.AddValues(7, 8d));` เรียกใช้ `AddValues(int a, double b)` ที่รับ parameter เป็น int และ double 
2. `Console.WriteLine(Calaulator.AddValues(1, 2));` เรียกใช้ `AddValues(int a, int b)` ที่รับ parameter เป็น int สองตัว 
3. `Console.WriteLine(Calaulator.AddValues(1, 2, 3));` เรียกใช้ `AddValues(int a, int b, int c)` ที่รับ parameter เป็น int สามตัว
4. `Console.WriteLine(Calaulator.AddValues(5f, 6f));` เรียกใช้ `AddValues(int a, float b)` ที่รับ parameter เป็น int และ float 
5. `Console.WriteLine(Calaulator.AddValues(9f, 4));` เรียกใช้ `AddValues(double a, double b)` ที่รับ parameter เป็น double สองตัว (เนื่องจากไม่มี method ที่รับ int และ int)
---
...
```
![image](https://user-images.githubusercontent.com/115066186/236043345-6ff93eb2-42af-41ce-a725-ae0d14273e9f.png)
...
```
![Screenshot 2023-05-04 033822](https://user-images.githubusercontent.com/115066186/236044248-53882147-73af-4a77-9c1e-b363337e9766.png)
![Screenshot 2023-05-04 033845](https://user-images.githubusercontent.com/115066186/236044259-32ca3b61-0c3a-4906-9631-bd0296a0f48f.png)
