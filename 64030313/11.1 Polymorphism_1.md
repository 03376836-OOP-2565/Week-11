...
```
### ผลการรันโปรแกรม
![image](https://user-images.githubusercontent.com/115037574/235780515-1a8619f7-4397-4c2b-bfbe-22152ce0ec08.png)

## คำถาม
1. โปรแกรมด้านบนสามารถทำงานได้ทุกบรรทัดหรือไม่
```
สามารถทำงานได้ปกติทุกบรรทัด
```
3. จงระบุว่าคำสั่งใดใน Main() เรียก method ใดในคลาส Calculator 
  - Calaulator.AddValues(7, 8d) เรียก method AddValues(int a, double b) โดยมี parameter a เป็น int 7 และ parameter b เป็น double 8d
  - Calaulator.AddValues(1, 2) เรียก method AddValues(int a, int b) โดยมี parameter a เป็น int 1 และ parameter b เป็น int 2
  - Calaulator.AddValues(1, 2, 3) เรียก method AddValues(int a, int b, int c) โดยมี parameter a เป็น int 1, parameter b เป็น int 2 และ parameter c เป็น int 3
  - Calaulator.AddValues(5f, 6f) เรียก method AddValues(int a, float b) โดยมี parameter a เป็น int 5 และ parameter b เป็น float 6f
  - Calaulator.AddValues(9f, 4) เรียก method AddValues(int a, double b) โดยมี parameter a เป็น float 9f และ parameter b เป็น int 4 (ตัวที่ 2 ใน method นี้จะถูก cast เป็น double)
---
...
```
### ผลการรันโปรแกรม
![image](https://user-images.githubusercontent.com/115037574/235780987-85fd76a5-ff98-46e1-921c-8147960974bb.png)
...
```
### ผลการรันโปรแกรม
![image](https://user-images.githubusercontent.com/115037574/235781147-5a5a5b6b-9c65-4ca2-8aa7-689f35f3ed83.png)
