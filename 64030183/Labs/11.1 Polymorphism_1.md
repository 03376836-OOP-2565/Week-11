...
```
![image](https://user-images.githubusercontent.com/115066431/236672349-e40d3f53-15bb-48b9-b959-0e84be1a84b4.png)
...
```cs
Console.WriteLine(Calaulator.AddValues(7, 8d)) เรียกใช้ method AddValues(int a, double b)

Console.WriteLine(Calaulator.AddValues(1, 2)) เรียกใช้ method AddValues(int a, int b)

Console.WriteLine(Calaulator.AddValues(1, 2, 3)) เรียกใช้ method AddValues(int a, int b, int c)

Console.WriteLine(Calaulator.AddValues(5f, 6f)) เรียกใช้ method AddValues(int a, float b)

Console.WriteLine(Calaulator.AddValues(9f, 4)) เรียกใช้ method AddValues(int a, float b) โดยมีการแปลงค่าตัวเลข 4 เป็น float ก่อน ดังนั้น method ที่ถูกเรียกใช้จะเป็น AddValues(int a, float b)
```
---
...
```
![image](https://user-images.githubusercontent.com/115066431/236672521-c4a86b16-6e3f-496a-be55-3d80f16a10ad.png)
...
```
![image](https://user-images.githubusercontent.com/115066431/236672607-4e796b44-deee-48a5-9ade-cbde8539034e.png)
