...
```
![image](https://user-images.githubusercontent.com/115066356/236405915-5683e5d9-b109-4835-93d3-da0c1aa69948.png)

## คำถาม
1. โปรแกรมด้านบนสามารถทำงานได้ทุกบรรทัดหรือไม่
```
โปรแกรมทำงานได้ทุกบรรทัด
```
...
```
![image](https://user-images.githubusercontent.com/115066356/236406586-4e005ed6-406c-4be9-96be-1454acdf975d.png)
...
```
![image](https://user-images.githubusercontent.com/115066356/236406896-b7d6fb25-d28f-44e1-92e0-17f3351cde56.png)
