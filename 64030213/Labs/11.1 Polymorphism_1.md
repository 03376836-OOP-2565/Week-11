...
```
![image](https://github.com/Suthera213/OOP2565-Week-11/assets/115066359/f00b6037-6fb4-4181-beb0-6e42ecd8d1d2)
...
```
![image](https://github.com/Suthera213/OOP2565-Week-11/assets/115066359/a02c59be-a6c6-47e4-aa23-c96083fab467)
...
```
![image](https://github.com/Suthera213/OOP2565-Week-11/assets/115066359/e576e917-0bf7-4328-aa0e-4a300600ffee)
```
โปรแกรมไม่สามารถรันได้เนื่องจาก Duck.mode() ไม่สามารถ override class Bird ได้ เพราะ class Bird 
ถูก sealed อยู่สามารถแก้ไขได้โดยการเปลี่ยน override ของ Duck.move() เป็น newเพื่อบอกว่าเราจะสร้าง duck.mode()ขึ้นมาใหม่
```
...
```
![image](https://github.com/Suthera213/OOP2565-Week-11/assets/115066359/e5e88f54-a864-4cd7-8372-721405d4a1d4)
